...
const Team = () => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      phone: (teamMem && teamMem.phone) || "",
      password: (teamMem && teamMem.password) || "",
      role_id: (teamMem && teamMem.role_id) || "01",
    },
    validationSchema: Yup.object({
      name: Yup.string().required("Please Enter team Name"),
      designation: Yup.string().required("Please Enter Admin Email"),
      phone: Yup.string().required("Please Enter Admin Phone Number"),
      password: Yup.string().required("Please Enter Admin Password"),
      role_id: Yup.string().required("Please Select Admin Role"),
    }),
    onSubmit: (values) => {
      if (isEdit) {
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Admin" pageTitle="Dashboard" />
          <Card>
            <CardBody>
              <Row className="g-2">
                <Col sm={4}>
                            ...
                            <Col lg={12}>
                              <div className="mb-3">
                                ...
                                <div className="position-relative auth-pass-inputgroup mb-3">
                                  ...
                                  >
                                    <option value="01">Maker</option>
                                    <option value="02">Checker</option>
                                  </Input>
                                  {validation.touched.role_id &&
                                  validation.errors.role_id ? (
                                    <FormFeedback type="invalid">
